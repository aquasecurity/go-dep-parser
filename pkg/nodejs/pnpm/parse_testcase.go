...
var (
	...
	pnpmNormal = []types.Library{
		...
		{ID: "jquery@3.6.0", Name: "jquery", Version: "3.6.0"},
		{ID: "promise@8.1.0", Name: "promise", Version: "8.1.0"},
	}
	...
	pnpmWithDev = []types.Library{
		{ID: "@babel/runtime@7.18.3", Name: "@babel/runtime", Version: "7.18.3"},
		{ID: "js-tokens@4.0.0", Name: "js-tokens", Version: "4.0.0"},
		{ID: "loose-envify@1.4.0", Name: "loose-envify", Version: "1.4.0"},
		{ID: "react@18.1.0", Name: "react", Version: "18.1.0"},
		{ID: "redux@4.2.0", Name: "redux", Version: "4.2.0"},
		{ID: "regenerator-runtime@0.13.9", Name: "regenerator-runtime", Version: "0.13.9"},
	}
