...
var (
	...
	wantMaven = []types.Library{
		types.NewLibrary("com.example:web-app", "1.0-SNAPSHOT", ""),
		types.NewLibrary("com.fasterxml.jackson.core:jackson-databind", "2.9.10.6", ""),
		types.NewLibrary("com.fasterxml.jackson.core:jackson-annotations", "2.9.10", ""),
		types.NewLibrary("com.fasterxml.jackson.core:jackson-core", "2.9.10", ""),
		types.NewLibrary("com.cronutils:cron-utils", "9.1.2", ""),
		types.NewLibrary("org.slf4j:slf4j-api", "1.7.30", ""),
		types.NewLibrary("org.glassfish:javax.el", "3.0.0", ""),
		types.NewLibrary("org.apache.commons:commons-lang3", "3.11", ""),
	}
	...
	wantGradle = []types.Library{
		types.NewLibrary("commons-dbcp:commons-dbcp", "1.4", ""),
		types.NewLibrary("commons-pool:commons-pool", "1.6", ""),
		types.NewLibrary("log4j:log4j", "1.2.17", ""),
		types.NewLibrary("org.apache.commons:commons-compress", "1.19", ""),
	}

	// manually created
	wantSHA1 = []types.Library{
		types.NewLibrary("org.springframework:spring-core", "5.3.3", ""),
	}

	// offline
	wantOffline = []types.Library{
		types.NewLibrary("org.springframework:Spring Framework", "2.5.6.SEC03", ""),
	}

	// manually created
	wantHeuristic = []types.Library{
		types.NewLibrary("com.example:heuristic", "1.0.0-SNAPSHOT", ""),
	}

	// manually created
	wantFatjar = []types.Library{
		types.NewLibrary("com.google.guava:failureaccess", "1.0.1", ""),
		types.NewLibrary("com.google.guava:guava", "29.0-jre", ""),
		types.NewLibrary("com.google.guava:listenablefuture", "9999.0-empty-to-avoid-conflict-with-guava", ""),
		types.NewLibrary("com.google.j2objc:j2objc-annotations", "1.3", ""),
		types.NewLibrary("org.apache.hadoop.thirdparty:hadoop-shaded-guava", "1.1.0-SNAPSHOT", ""),
	}
)
