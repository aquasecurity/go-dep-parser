...
var (
	...
	GoModNormal = []types.Library{
		{Name: "github.com/aquasecurity/go-dep-parser", Version: "0.0.0-20211224170007-df43bca6b6ff", Indirect: false, ExternalReferences: []types.ExternalRef{{Type: types.Vcs, Url: "https://github.com/aquasecurity/go-dep-parser"}}},
		{Name: "golang.org/x/xerrors", Version: "0.0.0-20200804184101-5ec99f83aff1", Indirect: true},
		{Name: "gopkg.in/yaml.v3", Version: "3.0.0-20210107192922-496545a6307b", Indirect: true, ExternalReferences: []types.ExternalRef{{Type: types.Vcs, Url: "https://github.com/go-yaml/yaml"}}},
	}

	// execute go mod tidy in replaced folder
	GoModReplaced = []types.Library{
		{Name: "github.com/aquasecurity/go-dep-parser", Version: "0.0.0-20220406074731-71021a481237", Indirect: false, ExternalReferences: []types.ExternalRef{{Type: types.Vcs, Url: "https://github.com/aquasecurity/go-dep-parser"}}},
		{Name: "golang.org/x/xerrors", Version: "0.0.0-20200804184101-5ec99f83aff1", Indirect: true},
	}
